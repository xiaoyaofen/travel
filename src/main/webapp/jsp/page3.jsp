...
<div class="container trblock clearfix " id="trblock178888">
    <div class=" col-lg-9" id="trleft178888">
        ...
        <div class="hlgd-title">
            <div class="hlgdttxt"><a href="/page/getCountryStory  "> </a></div>
            <hr>
        </div>
            ...
            <e:forEach items="${StoryList}"  var="item">
                <c:if test="${StoryList!=null}">
                    <div class="hlgd-box">
                        <dl>
                            <dt class="dis">
                                <a   href="${pageContext.request.contextPath}/page/getResource?type=3&id=${item.id}" onclick="pageRead(this)">
                                    <img width="250" height="165" border="0" alt="${item.name}" src="${item.img}">
                                </a>
                            </dt>
                            <a   href="${pageContext.request.contextPath}/page/getResource?type=3&id=${item.id}" onclick="pageRead(this)"></a>
                            <dd class="">
                                <a  href="${pageContext.request.contextPath}/page/getResource?type=3&id=${item.id}" onclick="pageRead(this)"></a>
                                <h3>
                                    <a   href="${pageContext.request.contextPath}/page/getResource?type=3&id=${item.id}" onclick="pageRead(this)">
                                <span class="dj">
                                    ...
                                    <a href="${pageContext.request.contextPath}/page/getResource?type=3&id=${item.id}" onclick="pageRead(this)"><b>${item.name}</b></a>
                                </h3>
...
<script>
    ...
    function pageRead(){
        /* $.ajax({
             url:$("#path").val()+"page/getResource?type=3&id=${item.id}",
            data:data.field,
            method:'post',
            dataType:'text',
