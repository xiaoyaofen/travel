                ...
                <form class="layui-form">
                  <div class="layui-form-item">
                      ...
                      <div class="layui-input-inline">
                          <input type="text" id="username" name="coachName" required="" lay-verify="required"
                  ...
                  <div class="layui-form-item">
                        ...
                        <input value="1" type="radio" name="coachSex" lay-skin="primary" title="男">
                        <input value="2" type="radio" name="coachSex" lay-skin="primary" title="女" checked="checked">
                  </div>
                  <div class="layui-form-item">
