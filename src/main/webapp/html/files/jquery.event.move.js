...
//                    n.el.css("width", Math.min(Math.round(n.el.outerWidth() / n.el.parent().outerWidth() * 100), 100) + "%")
            ...
            if (this.opts.arrows) {
                this.el.parent().append('<p class="arrows"><span class="prev">¡û</span><span class="next">¡ú</span></p>').find(".arrows span").click(function () {
